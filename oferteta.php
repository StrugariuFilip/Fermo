   ...
   <body>
      ...
      <main>
         <div class="content">
            <?php
               ...
               if ($source == "sesiune") { {
                   if ($num_results != 0) {
                       ...
                       echo "<p style=\"font-size:35px; margin-top:300px; margin-bottom:300px;\">Nu ai publicat nici o ofertă.</p>";
                   }
                    if ($num_results == 1)
                    {
            ...
            <a href="oferteviewta.php?id=<?php echo $row['id']; ?>" class="linke">
               <div class="container1">
                  ...
                  <div class="informatie">
                     <span class="prima">
                        ...
                        <form action="delete_offer.php" method="POST" onsubmit="return confirm('Esti sigur ca vrei sa stergi aceasta oferta?');" class="delete1">
                           <input type="hidden" name="offer_id" value="<?php echo $row['id']; ?>">
                           <button type="submit" class="delete-button"><i class="fas fa-trash"></i> Șterge oferta</button>
                        </form>
                     </span>
                     <div class="locatie-oferta2"><?php echo $row['judet'] . ', ' . $row['address']; ?>&nbsp;</div>
                     ...
                     <div class="timp-oferta2" style="color: black; font-size: 16px;">Publicată
                        pe:&nbsp;<?php echo $row['data'] ?>
                     </div>
                     <form action="delete_offer.php" method="POST" onsubmit="return confirm('Esti sigur ca vrei sa stergi aceasta oferta?');" class="delete2">
                        <input type="hidden" name="offer_id" value="<?php echo $row['id']; ?>">
                        <button type="submit" class="delete-button2"><i class="fas fa-trash"></i> Șterge oferta</button>
                     </form>
                  </div>
               </div>
            </a>
