...
<body>
    ...
    <main>
        <div class="content">
            ...
            $query = "SELECT * FROM oferte WHERE JSON_CONTAINS(favorite, '\"$username\"', '$')";
            ...
            if (!$result) {
                ...
                if ($num_results > 0) {
                    echo "<h2>Ai adăugat la favorite $num_results ";
                    echo ($num_results == 1) ? "ofertă." : "oferte.";
                    echo "</h2>";
                } else {
                    echo "<p style=\"font-size:35px; margin-top:300px; margin-bottom:300px;\">Nu ai adăugat la favorite nici o ofertă.</p>";
                }
                 if ($num_results == 1)
                    {
