        ...
        <body>
            ...
            <main>
                ...
                if (isset($_GET['username'])) {
                    ...
                    if ($source == "URL") {
                                if( $num_results !=0)
                         {echo "<h2>$username a publicat $num_results ";
                            ...
                            <a href="oferteview.php?id=<?php echo $row['id']; ?>" class="linke">
                                <div class="container1">
                                    ...
                                    <div class="informatie">
                                        <span class="prima"><div class="informatie-oferta1"><?php echo $row['name']; ?></div>
                                         <form action="delete_offer.php" method="POST" onsubmit="return confirm('Esti sigur ca vrei sa stergi aceasta oferta?');">
