...
<head>
    ...
    <title>Ofertele raportate</title>
...
<body>
    ...
    <main>
        <div class="content">
            ...
            $query = "SELECT * FROM oferte WHERE JSON_CONTAINS(report_users, '\"$username\"', '$')";
            ...
            if (!$result) {
                ...
                if ($num_results > 0) {
                    echo "<h2>Ai raportat $num_results ";
                    echo ($num_results == 1) ? "ofertă." : "oferte.";
                    echo "</h2>";
                } else {
                    echo "<p style=\"font-size:35px; margin-top:300px; margin-bottom:300px;\">Nu ai raportat nici o ofertă.</p>";
                }
                 if ($num_results == 1)
                    {
